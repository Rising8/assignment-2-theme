...
<section class="about-us" id="about">
    <div class="container">
        <h2>About Esports Arena</h2>
        <p>Welcome to Esports Arena, the ultimate destination for competitive gaming and esports tournaments. Whether you're a player, a fan, or just looking to catch the latest esports news, we've got you covered. From live streams to real-time leaderboards, Esports Arena brings you closer to the action.</p>
        
        <h3>What We Offer</h3>
        <ul>
            <li><strong>Leaderboards:</strong> Track your favorite teams and see who’s on top across various games.</li>
            <li><strong>Tournaments:</strong> Stay up-to-date with news on upcoming tournaments and events.</li>
            <li><strong>Live Streams:</strong> Watch popular live streams and stay up-to-date with any ongoing and upcoming tournaments.</li>
            <li><strong>Latest News:</strong> Get the latest updates on tournaments, teams, and players.</li>
        </ul>

        <h3>Why Choose Esports Arena?</h3>
        <p>Esports Arena is designed to be your one-stop destination for all things esports. Whether you're following the biggest tournaments or discovering new teams, we ensure that you never miss a moment of the action.</p>
